...
import com.charwayh.lime.common.dto.model.SmsContentModel;
import com.charwayh.lime.common.enums.ChannelType;
import com.charwayh.lime.handler.domain.sms.MessageTypeSmsConfig;
...
import com.charwayh.lime.handler.script.SmsScriptHolder;
import com.charwayh.lime.support.mapper.SmsRecordMapper;
...
public class SmsHandler extends BaseHandler implements Handler {
        ...
        try {
            ...
            for (MessageTypeSmsConfig messageTypeSmsConfig : messageTypeSmsConfigs) {
                ...
                if (CollUtil.isNotEmpty(recordList)) {
                    smsRecordMapper.saveBatch(recordList);
                    return true;
                }
            }
        } catch (Exception e) {
    ...
    private List<MessageTypeSmsConfig> getMessageTypeSmsConfig(Integer msgType) {
        ...
        String property = config.getProperty(apolloKey, LimeConstant.APOLLO_DEFAULT_VALUE_JSON_ARRAY);
