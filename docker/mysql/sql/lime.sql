...
-- 实时类型 短信（无占位符）
INSERT INTO lime.message_template (id, name, audit_status, flow_id, msg_status, cron_task_id, cron_crowd_path,
...
INSERT INTO lime.message_template (id, name, audit_status, flow_id, msg_status, cron_task_id, cron_crowd_path,
                                     ...
                                     send_account, creator, updator, auditor, team, proposer, is_deleted, created,
                                     updated)
VALUES (4, '买一送十活动', 10, '', 10, null, '', '', 30, 30, 20, 20, '{"content":"6666","url":"","title":""}', 10, '罗志祥',
        '罗志祥', '3y', '公众号Java3y', '罗志祥', 0, 1646274112, 1646275242);
...
INSERT INTO lime.message_template (id, name, audit_status, flow_id, msg_status, cron_task_id, cron_crowd_path,
                                     ...
                                     send_account, creator, updator, auditor, team, proposer, is_deleted, created,
                                     updated)
VALUES (5, '校招信息', 10, '', 10, null, '', '', 50, 40, 20, 10, '{"content":"你已成功获取到offer","url":"","title":"招聘通知"}', 10,
        '潘玮柏', '潘玮柏', '3y', '公众号Java3y', '潘玮柏', 0, 1646274195, 1646274195);
...
INSERT INTO lime.message_template (id, name, audit_status, flow_id, msg_status, cron_task_id, cron_crowd_path,
                                     ...
                                     send_account, creator, updator, auditor, team, proposer, is_deleted, created,
                                     updated)
VALUES (6, '验证码通知', 10, '', 10, null, '', '', 30, 30, 20, 30, '{"content":"{$content}","url":"","title":""}', 10,
        '周杰伦', '周杰伦', '3y', '公众号Java3y', '周杰伦', 0, 1646275213, 1646275213);
...
INSERT INTO lime.message_template (id, name, audit_status, flow_id, msg_status, cron_task_id, cron_crowd_path,
                                     ...
                                     send_account, creator, updator, auditor, team, proposer, is_deleted, created,
                                     updated)
VALUES (7, '验证码通知', 10, '', 10, null, '', '', 30, 30, 20, 30, '{"content":"{$content}","url":"","title":""}', 10,
        '周杰伦', '周杰伦', '3y', '公众号Java3y', '周杰伦', 0, 1646275213, 1646275213);
...
INSERT INTO lime.message_template (id, name, audit_status, flow_id, msg_status, cron_task_id, cron_crowd_path,
                                     ...
                                     send_account, creator, updator, auditor, team, proposer, is_deleted, created,
                                     updated)
VALUES (8, '定时邮件', 10, '', 10, null,'/Users/CharwayH/temp/30e55efde65a45fc8a0c978a2594faca2.csv', '0 0 * * * ? *	50	40	10	10	10', 30, 30, 10, 30, '{"content":"我觉得OK","title":"定时邮件"}', 10,
        'charwayh', 'charwayh', 'charwayh', 'charwayh', 'charwayh', 0, 1665393999, 1665393999);
