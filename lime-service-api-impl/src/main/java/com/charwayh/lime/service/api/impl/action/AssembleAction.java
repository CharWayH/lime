package com.charwayh.lime.service.api.impl.action;
...
import com.charwayh.lime.support.pipeline.BusinessProcess;
import com.charwayh.lime.support.pipeline.ProcessContext;
import com.charwayh.lime.support.utils.ContentHolderUtil;
import com.charwayh.lime.support.utils.TaskInfoUtils;
...
public class AssembleAction implements BusinessProcess<SendTaskModel> {
    ...
    public void process(ProcessContext<SendTaskModel> context) {
        ...
        try {
            ...
            if (!messageTemplate.isPresent() || messageTemplate.get().getIsDeleted().equals(LimeConstant.TRUE)) {
