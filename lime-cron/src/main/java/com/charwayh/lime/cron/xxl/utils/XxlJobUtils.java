package com.charwayh.lime.cron.xxl.utils;
...
import com.charwayh.lime.cron.xxl.enums.*;
...
public class XxlJobUtils {
    ...
    public XxlJobInfo buildXxlJobInfo(MessageTemplate messageTemplate) {
        ...
        XxlJobInfo xxlJobInfo = XxlJobInfo.builder()
                ...
                .triggerStatus(LimeConstant.FALSE)
    ...
    private Integer queryJobGroupId() {
        ...
        if (basicResultVO.getData() == null) {
            XxlJobGroup xxlJobGroup = XxlJobGroup.builder().appname(appName).title(jobHandlerName).addressType(LimeConstant.FALSE).build();
